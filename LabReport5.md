...
For this lab report i am going to focus on the contents from lab report 3. I am doing this lab report specifically because I find this lab report to be quite fundemental
in terms of knowledge and skills needed when it comes to file searching and etc. In this case, I will go over the lab report following the steps needed to complete it.
